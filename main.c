...
/*   Updated: 2025/09/09 16:18:02 by psantos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **envp)
{
	...
	t_ast *node_ls, *node_grep, *node_wc;
	t_ast *pipe1, *pipe2;

	// Create `ls -l` command node
	node_ls = malloc(sizeof(t_ast));
	node_ls->type = NODE_COMMAND;
	...
	// Create `grep command` command node
	...
	// Create first pipe node: ls -l | grep command
	...
	// Create second pipe node: ls -l | grep command | wc -l
